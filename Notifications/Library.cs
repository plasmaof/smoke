...
namespace smokemenu.Notifications
{
    ...
    public class NotifiLib : BaseUnityPlugin
    {
        ...
        {
            //NotifiLib.NotifiText.text = "<color=grey>[</color><color=green>sucess</color><color=grey>]</color> <color=white>notifications cleared</color>" + Environment.NewLine;
