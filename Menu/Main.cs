...
using static smokemenu.Menu.Buttons;
using static smokemenu.Settings;
using smokemenu.Menu;
using smokemenu;
using static smokemenu.Classes.CustomProperty;
        ...
        public static void CreateMenu()
        {
            ...
            // Buttons
                ...
                // Page Buttons
                    ...
                    gameObject.transform.localPosition = new Vector3(0f, 0f, 0.74f);
                    ...
                    component.localPosition = new Vector3(0.02f, 0f, 0.28f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
                    ...
                    gameObject.transform.rotation = Quaternion.identity;
                    gameObject.transform.localScale = new Vector3(0.09f, 0.9f, 0.08f);
                    gameObject.transform.localPosition = new Vector3(0, 0f, 0.64f);
                    gameObject.GetComponent<Renderer>().material.color = buttonColors[0].colors[0].color;
                    ...
                    component.localPosition = Vector3.zero;
                    component.sizeDelta = new Vector2(0.2f, 0.03f);
                    component.localPosition = new Vector3(0.02f, 0f, 0.24f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
